...
<html lang="en">
    <head>
        ...
        <script>
            ...
            function Reply_clicked(id, original)
            {
                $("#hdnTweetid").val(id);
                $("#opID").val(original);
            }
                        ...
                        <div class="bold">
                            <table border="0" cellspacing="1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                <br><td colspan="2" style="padding-top: 10%;"> <img src="Images/location.png" width="15%"alt="location"/><?php echo $CurrentUser->getLocation(); ?></tr>
                                <tr>  <td colspan="3">
                                        Member Since: <?php
